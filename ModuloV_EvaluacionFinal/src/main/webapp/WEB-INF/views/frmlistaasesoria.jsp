...
<body>
   ...
   <header>
    ...
    <section class="contact-section">
        ...
        <tbody>
        <c:forEach items="${lasesorias}" var="a">
        <tr>
          <td><c:out value="${a.getIdasesoria()}" /></td>
          <td><c:out value="${a.getFecharealizacion()}" /></td>
          <td><c:out value="${a.getMotivo()}" /></td>
          <td><c:out value="${a.getCliente_rutcliente()}" /></td>
          <td><c:out value="${a.getProfesionales_runprofesional()}" /></td>
        </tr>
        </c:forEach>
        </tbody>
      </table>
