    ...
    <section class="contact-section">
    	<div class="container">
            ...
            <div class="container">    
                    ...
                    <div class="col-12">
                        <h2 class="contact-title">Creación Asesoria</h2>
                    </div>
                    <div class="border p-3 form">
                         <form class="form-contact contact_form" name="frmcrearid" id="frmcrearid" action='<c:out value="${pageContext.request.contextPath}"/>/procesaasesoria' method="post"  >
                            <div class="row">
                         
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="fechaasesoria" id="fechaasesoria" type="Date" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ingrese la fecha de la asesoria'" placeholder="Ingrese la fecha de la asesoria">
                                    </div>
                                </div>
                                
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="motivo" id="motivo" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ingrese el motivo de la asesoria'" placeholder="Ingrese el motivo de la asesoria" ></textarea>
                                    </div>
                                </div>
                                    ...
                                    <select class=" form-select form-control valid "  name="runcli" id="runcli" >
                                      <option selected>Seleccione el cliente asociado a la asesoria</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                    <select class=" form-select form-control valid "  name="runpro" id="runpro" >
                                      <option selected>Seleccione el profesional asosciado a la asesoria</option>
                                      	<c:forEach items="${lprofesionales}" var="p">
        								
                                      	<option value='<c:out value='${p.getRunprofesional()}' />'><c:out value="${p.getNombre_pro()}" /> <c:out value="${p.getApellido_pro()}" /></option>
                                      </c:forEach>
                                    </select>                                    
                                </div>
                                </div>
